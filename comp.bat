...
set AAPT_PATH=%ANDROID_HOME%\build-tools\23.0.1\aapt.exe
set DX_PATH=%ANDROID_HOME%\build-tools\23.0.1\dx.bat
set ANDROID_JAR=%ANDROID_HOME%\platforms\android-23\android.jar
set ADB=%ANDROID_HOME%\platform-tools\adb.exe

set PACKAGE_PATH=com/kay27/glukalo
set PACKAGE=com.kay27.glukalo
